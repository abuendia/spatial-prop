...
from spatial_gnn.utils.perturbation_utils import batch_steering_mean, batch_steering_cell_gpu
        ...
        for prop in props:
            ...
            for data in tqdm(test_loader):
                ...
                if steering_approach == "batch_steer_mean":
                    ...
                    pdata, target_celltype, target_expression, target_out = batch_steering_cell_gpu(
