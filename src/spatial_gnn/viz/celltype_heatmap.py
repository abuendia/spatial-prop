...
def plot_average_by_celltype():
    ...
    dataset_order = [d for d in datasets if d not in exclude_datasets]
    ...
    # Viridis split into 5; use first 3 (avoid yellow)
    ...
    bar_width = 0.22
    spacing_factor = 1.05  # >1 means small gaps; guarantees no overlap
    ...
    ax.set_ylabel(f"Macro Spearman ({metric_name})")
