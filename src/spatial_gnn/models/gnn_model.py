...
def predict(
    ...
    perturbed_dataloader : DataLoader, optional
    ...
    temper_method : str, optional
        ...
        "distribution_dampen", "distribution_renormalize", "renormalize". 
        Requires perturbed_dataloader to be provided.
    temper_param : float, default=0.05
        Parameter for tempering (quantile cutoff for distribution methods)
        
    Returns:
    --------
    AnnData
        Updated AnnData with predictions in .layers['predicted_perturbed'] or 
        .layers['perturbation_effects'] if tempering is applied
    """    
    model.eval()
    adata = adata.copy()
